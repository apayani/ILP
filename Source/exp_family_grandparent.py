...
#define constants
C=['Christopher','Arthur','Victoria' ,'Andrew', 'James' ,'Colin', 'Jennifer' , 'Charlotte', 'Emilio', 'Roberto', 'Lucia' , 'Pierro',  'Angela' , 'Marco', 'Alfonso' , 'Sophia','Penelope','Christine','Maria','Francesca','Margaret','Charles','Gina','Tomaso']
C=list(set(C))
Constants = dict( {'C':C })
...
bg.add_backgroud ('nephew', ('Colin', 'Arthur'))
bg.add_backgroud ('nephew', ('Colin', 'Jennifer'))
bg.add_backgroud ('nephew', ('Alfonso', 'Emilio'))
bg.add_backgroud ('nephew', ('Alfonso', 'Angela'))
bg.add_backgroud ('nephew', ('Colin', 'Margaret'))
bg.add_backgroud ('nephew', ('Colin', 'Charles'))
bg.add_backgroud ('nephew', ('Alfonso', 'Gina'))
bg.add_backgroud ('nephew', ('Alfonso', 'Tomaso'))
...
bg.add_example('grandparent', ('Christopher','Colin'))
bg.add_example('grandparent',('Christopher','Charlotte'))
bg.add_example('grandparent',('Andrew','Colin'))
bg.add_example('grandparent',('Andrew','Charlotte'))
bg.add_example('grandparent',('Roberto', 'Alfonso'))
bg.add_example('grandparent',('Roberto', 'Sophia'))
bg.add_example('grandparent',('Pierro','Alfonso'))
bg.add_example('grandparent',('Pierro','Sophia'))
bg.add_example('grandparent',('Penelope','Colin'))
bg.add_example('grandparent',('Penelope','Charlotte'))
bg.add_example('grandparent',('Christine','Colin'))
bg.add_example('grandparent',('Christine','Charlotte'))
bg.add_example('grandparent',('Maria','Alfonso'))
bg.add_example('grandparent',('Maria','Sophia'))
bg.add_example('grandparent',('Francesca','Alfonso'))
bg.add_example('grandparent',('Francesca','Sophia'))


         
bg.add_all_neg_example('grandparent') 
...
parser.add_argument('--MAX_DISP_ITEMS', default=1000 , help='Max number  of facts to display',type=int)
