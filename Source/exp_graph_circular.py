...
bg.add_backgroud ('edge', ('v','u') )
  
bg.add_example('circular',('b',))
bg.add_example('circular',('c',))
bg.add_example('circular',('d',))
bg.add_example('circular',('e',))
bg.add_example('circular',('u',))
bg.add_example('circular',('v',))

bg.add_all_neg_example('circular') 
...
parser.add_argument('--LR_SC', default={ (-1000,2):.005 ,  (2,1e5):.0005} , help='Learning rate schedule',type=dict)
